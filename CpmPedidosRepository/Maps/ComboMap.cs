...
namespace CpmPedidos.Repository
{
    public class ComboMap : BaseDomainMap<Combo>
    {
     public   ComboMap() : base("tb_combo") { }
        ...
        public new void Configure(EntityTypeBuilder<Combo> builder)
        {
            ...
            builder.HasMany(x => x.Produtos).WithMany(x => x.Combos).
                UsingEntity<ProdutoCombo>(
                x=>x.HasOne(f =>f.Produto).WithMany().HasForeignKey(x => x.IdProduto),
